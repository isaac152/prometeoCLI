...
#NOTE THIS FILE IS EXTRACTED FROM HERE: 
# https://github.com/bvalgard/create-pdf-with-python-fpdf2/blob/main/table_function.py
#I DIDNT MAKE THIS
#The author doesnt have any library for this function and, it helps a lot to make tables in pdf
